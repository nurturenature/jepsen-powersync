...
RUN wget --no-verbose https://storage.googleapis.com/flutter_infra_release/releases/stable/linux/flutter_linux_3.41.9-stable.tar.xz
RUN tar -xf ./flutter_linux_3.41.9-stable.tar.xz -C /usr/bin/
